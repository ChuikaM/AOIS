...
ftxui::Component MainMenuFactory::m_prepareMainMenu(int& m_current_tab)
{
...
ftxui::Component MainMenuFactory::m_prepareRegularTableMenu(int &m_current_tab)
{
...
ftxui::Component MainMenuFactory::m_prepareHashTableMenu(int &m_current_tab)
{
